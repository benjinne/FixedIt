				...
				<div class="error">${errorMessage}</div>
					...
					<table>
						<tr>
							...
							<td><input type="textInput" name="searchBySubject" size="12" value="${searchBySubject}" /></td>
						</tr>
						<tr>
							<td class="label">Search by Section: &nbsp;&nbsp;</td>
							<td><input type="textInput" name="searchBySection" size="12" value="${searchBySection}" /></td>
						</tr>
						<tr>
							<td class="label">Search by Level: &nbsp;&nbsp;</td>
							<td><input type="textInput" name="searchByLevel" size="12" value="${searchByLevel}" /></td>
						</tr>
			</table></center>
			<input class="Submit" type="button" value="Search!" onclick=fixedIt.controllers.QueryController.getCourses()>
			<br>
	</form>
	</section>
